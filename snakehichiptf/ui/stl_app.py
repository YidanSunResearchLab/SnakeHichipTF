...
st.set_page_config(page_title="Snakehichip UI", layout="wide")
st.title("Snakehichip — Local UI")
...
with tab2:
    st.subheader("Snakehichip — main RNA-seq pipeline")
