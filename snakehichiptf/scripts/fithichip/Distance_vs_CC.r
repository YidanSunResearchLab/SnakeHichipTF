...
min_dist <- min(5000, min(DistVec))
max_dist <- max(2000000, max(DistVec))
histdata <- data.frame(dist=DistVec)

max_hist_freq <- max(hist(histdata$dist, breaks <- seq(floor(min(DistVec)/10000)*10000, ceiling(max(DistVec)/10000)*10000, by=10000), plot=FALSE)$counts)
